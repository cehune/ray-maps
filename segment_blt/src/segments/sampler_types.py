...
class SequentialSampler(Sampler):
    ...
    def conditional_pdf(self, segment: Segment, auxiliary: Segment) -> float:
        ...
        # NOTE: the to-light bridge mass used to be folded in here as
        # `+ p_bridge`. It is now its own path-construction technique
...
class BridgeSampler(Sampler):
    ...
    to-light bridges. Applies to any light-terminal segment (bridge-made OR BSDF-found light
