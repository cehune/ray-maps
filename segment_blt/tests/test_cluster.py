...
class TestCluster:
    ...
    # NOTE: tests for the 1/K kernel-area correction were removed along with the
    # correction itself — it double-counts the kernel area (the area cancels in
    # the MMIS denominator), so the estimator never used it.