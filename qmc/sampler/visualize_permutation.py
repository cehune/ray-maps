...
# Support both "python sampler/visualize_permutation.py" and "-m sampler...".
try:
    from .direction_numbers import load_direction_numbers
    from .sobol_sampler import SobolSampler
    from .padded_sobol_sampler import PaddedSobolSampler
    from .scramble import NoScramble, RandomDigitScramble, OwenScramble
except ImportError:
    import sys
    sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    from sampler.direction_numbers import load_direction_numbers
    from sampler.sobol_sampler import SobolSampler
    from sampler.padded_sobol_sampler import PaddedSobolSampler
    from sampler.scramble import NoScramble, RandomDigitScramble, OwenScramble
