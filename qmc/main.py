...
def main():
    ...
    p.add_argument('--out-dir', default="/Users/celine/Documents/projects/ray-maps/qmc/outputs")
    args = p.parse_args()
    ...
    if args.scalar:
        ...
        from pathtracer import BasicPathTracer as Integrator
        itype = 'basic_pt'
    else:
        mi.set_variant('llvm_ad_rgb')
        from pathtracer_vec import BasicPathTracerVec as Integrator
        itype = 'basic_pt_vec'
